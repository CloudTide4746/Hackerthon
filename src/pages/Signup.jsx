  ...
  return (
    <div className='min-h-screen bg-slate-950 flex items-center justify-center p-4 relative overflow-hidden'>
      ...
      <div className='w-full max-w-md relative z-10'>
        <Link
          to='/'
          className='inline-flex items-center mb-8 text-slate-400 hover:text-indigo-400 transition-colors group'
        >
        ...
        <div className='glass-card rounded-2xl p-8 border border-slate-800'>
          <div className='text-center mb-8'>
            <h1 className='text-3xl font-bold text-slate-100 mb-2'>创建账户</h1>
            <p className='text-slate-400'>加入我们的黑客松项目</p>
          </div>
          ...
          <SignUp
            appearance={{
              elements: {
                ...
                formButtonPrimary:
                  "bg-indigo-600 hover:bg-indigo-500 text-white !shadow-none !border-none",
                formFieldInput:
                  "bg-slate-900/50 border-slate-700 text-slate-100 focus:border-indigo-500",
