      ...
      <div className='relative group z-10'>
        ...
        <div className='relative bg-slate-900 border border-slate-700 rounded-xl overflow-hidden flex flex-col shadow-lg'>
          ...
          <textarea
            ...
            disabled={isLoading}
            placeholder={
              isLoading ? "正在处理中..." : "在此输入您的补充问题..."
            }
            className='w-full h-24 bg-transparent p-4 text-slate-200 focus:outline-none resize-none text-sm leading-relaxed placeholder:text-slate-600 disabled:opacity-50'
          />
