        ...
        {screenshots.length === 0 ? (
          ...
          <div className='flex flex-col gap-3'>
            {screenshots.map((shot) => (
              <div
                key={shot.id}
                className='bg-slate-900/40 p-2 rounded-xl border border-slate-800/50 hover:border-indigo-500/30 transition-all duration-300 group relative hover:bg-slate-800/60'
              >
